<aside class="sidebar" id="Sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-menu-item @if(request()->is('invoices')) active @endif"><a href="/invoices"><i class="fa-solid fa-file-invoice-dollar"></i>Invoice</a></li>
        ...
        <li class="sidebar-menu-item @if(request()->is('pengaturan')) active @endif"><a href="/pengaturan"><i class="fa fa-cog"></i>Pengaturan</a></li>
    </ul>
    @endguest
